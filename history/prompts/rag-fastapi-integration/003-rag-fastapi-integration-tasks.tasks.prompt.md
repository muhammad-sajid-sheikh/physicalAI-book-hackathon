...
user: "DELL"
command: "/sp.tasks"
labels: ["tasks", "fastapi", "rag", "api", "integration"]
links:
...
files_yaml: |
  ...
  - "history/prompts/rag-fastapi-integration/003-rag-fastapi-integration-tasks.tasks.prompt.md"
tests_yaml: |
  - "task-validation"
prompt_text: |
  $ARGUMENTS
response_text: |
  Generated comprehensive task list for RAG FastAPI integration:
  ...
  - All 9 functional requirements from spec addressed across tasks
